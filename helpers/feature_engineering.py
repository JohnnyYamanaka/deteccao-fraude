...
class FeatureEngineering():
    ...
    def transform_dataset(self):
        ...
        self.dataset['higherValue'] = self.dataset['amount'].apply(lambda x: 
                                        1 if x >= amount_third_quantile else 0)
        ...
        self.dataset['amountDiff'] = np.mean(self.dataset['amount']) - self.dataset['amount']
