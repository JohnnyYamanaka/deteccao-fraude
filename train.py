...
pipe_lr = Pipeline(steps=[("preprocessor", preprocessor), ("model", random_search_lr)])
...
pipe_xgb = Pipeline(
    steps=[("preprocessor", preprocessor), ("model", random_search_xgb)]
)
...
pipe_rf = Pipeline(steps=[("preprocessor", preprocessor), ("model", random_search_rf)])
